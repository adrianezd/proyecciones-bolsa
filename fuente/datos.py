"""
Descarga de cotizaciones: S&P 500 y otros grandes indices y fondos.
...
ACTIVOS = [
    ("sp500",   "^GSPC",     "^spx",   "S&P 500",       "puntos", "Bolsa"),
    ("nasdaq",  "^NDX",      "^ndq",   "Nasdaq 100",    "puntos", "Bolsa"),
    ("ibex",    "^IBEX",     "^ibex",  "IBEX 35",       "puntos", "Bolsa"),
    ("eurostx", "^STOXX50E", "^stx50", "Euro Stoxx 50", "puntos", "Bolsa"),
    ("nikkei",  "^N225",     "^nkx",   "Nikkei 225",    "puntos", "Bolsa"),
]
