...
BASE_URL = "https://adrianezd.github.io/proyecciones-bolsa"
...
def main() -> None:
    ...
    if not activos:
        print("  SALTADA     bolsa (ningun proveedor de cotizaciones respondio)")
    ...
    escribir(
        "activos.html",
        acento="bolsa",
        titulo="S&P 500 y otros indices y fondos: cotizacion y grafica interactiva",
        descripcion="Historico de cierre diario del S&P 500, el Nasdaq, el IBEX, el Euro "
                    "Stoxx y el Nikkei, con graficas interactivas.",
        encabezado="S&P 500 y otros fondos",
        bajada="Los grandes indices bursatiles del mundo, que es lo mismo a lo que sigue la "
               "mayoria de fondos indexados. Cierre diario, historico completo.",
